...
class GlassContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveTint = tint ??
        (isDark
            ? const Color(0xFF1c1c1e).withOpacity(0.3) // 暗色：深灰玻璃
            : const Color(0xFFFFFFFF).withOpacity(0.5)); // 亮色：白玻璃

    final effectiveBorder = borderColor ??
        (isDark
            ? const Color(0xFFFFFFFF).withOpacity(0.12) // 暗色：白色细线
            : const Color(0xFF000000).withOpacity(0.08)); // 亮色：黑色细线
